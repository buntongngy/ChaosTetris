...
public:
	PBlock()
	{
		...
		cells[2] = { Position(0,2), Position(0,3), Position(1,1), Position(1,2), Position(1,3) };
		cells[3] = { Position(0,2), Position(1,2), Position(1,3), Position(2,2), Position(2,3) };
...
public:
	PenJBlock()
	{
		...
		cells[1] = { Position(0,1), Position(1,1), Position(2,0), Position(2,1), Position(3,1) };
		cells[2] = { Position(1,0), Position(1,1), Position(1,2), Position(1,3), Position(2,3) };
		cells[3] = { Position(0,2), Position(1, 0), Position(1, 1), Position(2, 1), Position(3, 1) };
		Move(0, 4);
	}
};